...
INSERT INTO Coordinator (id, name)
VALUES (1, 'Сергей');

-- Заполнение таблицы Student
INSERT INTO Student (id, name, coordinator_id)
VALUES (1, 'Иван', 1),
       (2, 'Петр', 1),
       (3, 'Дмитрий', 1),
       (4, 'Юрий', 1),
...
INSERT INTO CourseStudent (course_id, student_id)
VALUES (1, 1), -- Иван записан на Java
